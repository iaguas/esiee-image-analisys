...
./bin/avgfilter img/cga/lena_grey_noisy.pgm img/cga/out/lenaGray-avgfilter-5.pgm 5
./bin/avgfilter_color img/cga/lena_std_noisy.ppm img/cga/out/lenaColor-avgfilter-5.ppm 5
